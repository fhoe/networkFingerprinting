...
static scamper_addr_t *tracebox_dst(void *data)
{
  return ((scamper_tracebox_t *)data)->dst;
}
...
static scamper_addr_t *fprinting_dst(void *data)
{
  return ((scamper_fprinting_t *)data)->dst;
}
...
int main(int argc, char *argv[])
{
  funcset_t funcs[] = {
    ...
    {(wf_t)scamper_file_write_tracebox,   (ff_t)scamper_tracebox_free, tracebox_dst},
    {(wf_t)scamper_file_write_sting,  (ff_t)scamper_sting_free, sting_dst},
    {NULL, NULL, NULL}, /* sniff */
	 {(wf_t)scamper_file_write_fprinting, (ff_t)scamper_fprinting_free, fprinting_dst},
  };
  uint16_t types[] = {
