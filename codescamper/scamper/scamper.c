...
#include "tracebox/scamper_tracebox_do.h"
#include "sniff/scamper_sniff_do.h"
#include "fprinting/scamper_fprinting_do.h"
...
static int check_options(int argc, char *argv[])
{
  static const scamper_multicall_t multicall[] = {
    ...
    {"scamper-tracebox", "tracebox",
     scamper_do_tracebox_arg_validate, scamper_do_tracebox_usage},
    {"scamper-sniff", "sniff",
     scamper_do_sniff_arg_validate, scamper_do_sniff_usage},
    {"scamper-fprinting", "fprinting",
     scamper_do_fprinting_arg_validate, scamper_do_fprinting_usage}
  };
  int   i;
...
static int scamper(int argc, char *argv[])
{
  ...
  if(scamper_do_trace_init() != 0 ||
     ...
     scamper_do_tracebox_init() != 0 ||
     scamper_do_sniff_init() != 0 ||
     scamper_do_fprinting_init() != 0)
    {
      return -1;
    }
...
static void cleanup(void)
{
  ...
  scamper_do_tracebox_cleanup();
  scamper_do_sniff_cleanup();
  scamper_do_fprinting_cleanup();
