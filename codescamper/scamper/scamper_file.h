...
#define SCAMPER_FILE_OBJ_TRACEBOX      0x0c
#define SCAMPER_FILE_OBJ_STING         0x0d
#define SCAMPER_FILE_OBJ_SNIFF         0x0e
#define SCAMPER_FILE_OBJ_FPRINTING     0x0f
